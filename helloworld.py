...
if setup:
  ...
  handlers = [
    ...
    #(prefix + r"/facebook", "controllers.facebook.FacebookAuthHandler"),
    ...
    #(prefix + r"/google", "controllers.google.GoogleAuthHandler"),
    ...
    (prefix + r"/twitter", "controllers.twitter.TwitterAuthHandler"),
