    ...
    if (li(e)) {
      ...
      if (Array.isArray(e)) {
        ...
        if (o.length) {
          ...
          return (
            n.every((u, c) => be(u, s[c], t)) && i.every((u, c) => be(u, a[c], t)) && (o.length === 0 || be(o[0], l, t))
          );
        }
          ...
          ((d = 0),
            ...
            u < 0
              ? ((me = E[0]),
                ...
                S < D && g.unshift(0),
                t(E, g, D, l),
                u == -1 && ((D = E.length), (u = r(_, E, H, D)), u < 1 && (d++, t(E, H < D ? fr : _, D, l))),
                (D = E.length))
              : u === 0 && (d++, (E = [0])),
            (R[p++] = d),
...
function y(e, r, t, n) {
  ...
  e: if (r != null) {
    ...
    if (
      (o == 0
        ? ((p.length = d), (a = 1), d--)
        : ((p.length = d + 1), (a = U(10, b - o)), (p[d] = s > 0 ? ((c / U(10, i - s)) % U(10, s) | 0) * a : 0)),
      u)
    )
      for (;;)
        if (d == 0) {
